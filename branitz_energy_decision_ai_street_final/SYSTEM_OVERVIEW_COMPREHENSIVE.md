# 🏗️ Branitz Energy Decision AI - Comprehensive System Overview
...
### **5. Visualization and Dashboard System**
**Location**: `src/cha.py`, `src/comprehensive_dashboard.py`, `src/street_dashboard.py`
- **Interactive Maps**: Folium-based network visualization
- **Comprehensive Dashboards**: Multi-agent result integration
- **Street-Specific Dashboards**: Individual street analysis
- **Real-time Updates**: Live KPI and metric updates
- **Export Capabilities**: HTML, PNG, GeoPackage formats
