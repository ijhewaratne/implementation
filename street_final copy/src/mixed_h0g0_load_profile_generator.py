...
class MixedH0G0LoadProfileGenerator:
    ...
    def calculate_h0_dynamic_factor(self, date):
        ...
        return a * day_of_year**4 + b * day_of_year**3 + c * day_of_year**2 + d * day_of_year + e
    ...
    def calculate_yearly_consumption(self, building_id):
        ...
        g0_consumption = (
            floor_area * 0.5 * 73.93
        )  # Standard G0-Verbrauch pro m² bei 50% gew. Flächennutzung
    ...
    def generate_load_profile(self, building_id, start_date, end_date):
        ...
        return pd.DataFrame({"timestamp": timestamps, "power_kw": power_values})
